...
# PATH
IMG_PATH_mv3 = "test/images"
LABELS_PATH_mv3 = "test/labels.txt"
MODEL_DIR_mv3 = "models/mv3large_none_bilstm_ctc"
DICT_DIR_mv3 = "models/plate_dict.txt"

# Load OCR model
ocr_mv3 = PaddleOCR(
    det_model_dir=MODEL_DIR_mv3,
    cls_model_dir=MODEL_DIR_mv3,
    det=False,
    cls=False,
...
accuracy_mv3, avg_time_ms_mv3, frame_rate_mv3 = evaluate(ocr_mv3, IMG_PATH_mv3, LABELS_PATH_mv3)
print(f"Accuracy: {accuracy_mv3}")
print(f"Inference Time: {avg_time_ms_mv3:.2f} ms")
print(f"FPS: {frame_rate_mv3:.2f}")
