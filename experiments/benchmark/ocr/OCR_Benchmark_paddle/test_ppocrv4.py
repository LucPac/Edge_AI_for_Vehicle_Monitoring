...
# PATH
IMG_PATH_ppocrv4 = "test/images"
LABELS_PATH_ppocrv4 = "test/labels.txt"
MODEL_DIR_ppocrv4 = "models/enppocrv4"
DICT_DIR_ppocrv4 = "models/plate_dict.txt"

# Load OCR model
ocr_ppocrv4 = PaddleOCR(
    det_model_dir=MODEL_DIR_ppocrv4,
    cls_model_dir=MODEL_DIR_ppocrv4,
    det=False,
    cls=False,
    rec_model_dir=MODEL_DIR_ppocrv4,
    rec_char_dict_path=DICT_DIR_ppocrv4,
...
accuracy_ppocrv4, avg_time_ms_ppocrv4, frame_rate_ppocrv4 = evaluate(ocr_ppocrv4, IMG_PATH_ppocrv4, LABELS_PATH_ppocrv4)
print(f"Accuracy: {accuracy_ppocrv4}")
print(f"Inference Time: {avg_time_ms_ppocrv4:.2f} ms")
print(f"FPS: {frame_rate_ppocrv4:.2f}")
